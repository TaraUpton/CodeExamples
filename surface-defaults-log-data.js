...
export const MODEL_NAME = "surfaceDefaultsLog";
export const FEATURE_NAME = "surfaceDefaults";
...
export const surfaceDefaultsLogSagas = createController(service, actions);
